Shader "Unlit/Diamond"
{
    Properties
    {
        ...
        [Toggle(_OPEN_REFRAC)] _Open_refrac ("是否开启反射",Float) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature _OPEN_REFRAC
