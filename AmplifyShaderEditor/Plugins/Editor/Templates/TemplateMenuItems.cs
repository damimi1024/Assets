...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Templates/DoublePass", false, 85 )]
		public static void ApplyTemplateTemplatesDoublePass()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "341d204219bc70646ae1e51b5d9aae9e" );
		}
